...
public class ShowMessage implements Runnable{
    ...
    public ShowMessage(JTable table, List<Message> messageList, JLabel labelFrom, JLabel labelSubject, JEditorPane pane) {
        this.table = table;
    ...
    public void showMessage() {
        ...
        System.out.println("Try to show message at row " + row);
        ...
        if(from.length() > 40) {
            String cutFrom ;
            cutFrom = from.substring(
                    from.indexOf("<")+1, from.lastIndexOf(">"));
